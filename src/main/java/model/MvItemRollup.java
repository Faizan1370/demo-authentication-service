...
/**
 * The persistent class for the mv_item_rollup database table.
 * 
 */
@Entity
@Table(name="mv_item_rollup")
@NamedQuery(name="MvItemRollup.findAll", query="SELECT m FROM MvItemRollup m")
public class MvItemRollup implements Serializable {
