...
/**
 * The persistent class for the mv_not_dead_awards database table.
 * 
 */
@Entity
@Table(name="mv_not_dead_awards")
@NamedQuery(name="MvNotDeadAward.findAll", query="SELECT m FROM MvNotDeadAward m")
public class MvNotDeadAward implements Serializable {
