...
/**
 * The persistent class for the email_data_v database table.
 * 
 */
@Entity
@Table(name="email_data_v")
@NamedQuery(name="EmailDataV.findAll", query="SELECT e FROM EmailDataV e")
public class EmailDataV implements Serializable {
