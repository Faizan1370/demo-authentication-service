...
/**
 * The persistent class for the item_award_data_v database table.
 * 
 */
@Entity
@Table(name="item_award_data_v")
@NamedQuery(name="ItemAwardDataV.findAll", query="SELECT i FROM ItemAwardDataV i")
public class ItemAwardDataV implements Serializable {
