...
/**
 * The persistent class for the bid_rollup_v database table.
 * 
 */
@Entity
@Table(name="bid_rollup_v")
@NamedQuery(name="BidRollupV.findAll", query="SELECT b FROM BidRollupV b")
public class BidRollupV implements Serializable {
