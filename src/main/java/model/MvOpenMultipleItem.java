...
/**
 * The persistent class for the mv_open_multiple_items database table.
 * 
 */
@Entity
@Table(name="mv_open_multiple_items")
@NamedQuery(name="MvOpenMultipleItem.findAll", query="SELECT m FROM MvOpenMultipleItem m")
public class MvOpenMultipleItem implements Serializable {
