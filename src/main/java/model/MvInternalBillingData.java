...
/**
 * The persistent class for the mv_internal_billing_data database table.
 * 
 */
@Entity
@Table(name="mv_internal_billing_data")
@NamedQuery(name="MvInternalBillingData.findAll", query="SELECT m FROM MvInternalBillingData m")
public class MvInternalBillingData implements Serializable {
	...
	@Column(name="billing_gms_cc")
	private BigDecimal billingGmsCc;

	@Column(name="billing_gms_non_cc")
	private BigDecimal billingGmsNonCc;
	...
	@Column(name="confirmed_donation_revenue_cc")
	private BigDecimal confirmedDonationRevenueCc;

	@Column(name="confirmed_donation_revenue_non_cc")
	private BigDecimal confirmedDonationRevenueNonCc;

	@Column(name="confirmed_donations")
	private BigDecimal confirmedDonations;

	@Column(name="confirmed_quick_sales")
	private BigDecimal confirmedQuickSales;

	@Column(name="confirmed_quick_sales_revenue_cc")
	private BigDecimal confirmedQuickSalesRevenueCc;

	@Column(name="confirmed_quick_sales_revenue_non_cc")
	private BigDecimal confirmedQuickSalesRevenueNonCc;

	@Column(name="confirmed_ticket_orders")
	private BigDecimal confirmedTicketOrders;

	@Column(name="confirmed_ticket_orders_revenue_cc")
	private BigDecimal confirmedTicketOrdersRevenueCc;

	@Column(name="confirmed_ticket_orders_revenue_non_cc")
	private BigDecimal confirmedTicketOrdersRevenueNonCc;
	...
	@Column(name="non_billable_gms")
	private double nonBillableGms;
	...
	@Column(name="unconfirmed_donation_revenue")
	private BigDecimal unconfirmedDonationRevenue;

	@Column(name="unconfirmed_donations")
	private BigDecimal unconfirmedDonations;

	@Column(name="unconfirmed_quick_sales")
	private BigDecimal unconfirmedQuickSales;

	@Column(name="unconfirmed_quick_sales_revenue")
	private BigDecimal unconfirmedQuickSalesRevenue;

	@Column(name="unconfirmed_ticket_orders")
	private BigDecimal unconfirmedTicketOrders;

	@Column(name="unconfirmed_ticket_orders_revenue")
	private BigDecimal unconfirmedTicketOrdersRevenue;

	public MvInternalBillingData() {
	}
	...
	public BigDecimal getBillingGmsCc() {
		return this.billingGmsCc;
	}

	public void setBillingGmsCc(BigDecimal billingGmsCc) {
		this.billingGmsCc = billingGmsCc;
	}

	public BigDecimal getBillingGmsNonCc() {
		return this.billingGmsNonCc;
	}

	public void setBillingGmsNonCc(BigDecimal billingGmsNonCc) {
		this.billingGmsNonCc = billingGmsNonCc;
	}
	...
	public BigDecimal getConfirmedDonationRevenueCc() {
		return this.confirmedDonationRevenueCc;
	}

	public void setConfirmedDonationRevenueCc(BigDecimal confirmedDonationRevenueCc) {
		this.confirmedDonationRevenueCc = confirmedDonationRevenueCc;
	}

	public BigDecimal getConfirmedDonationRevenueNonCc() {
		return this.confirmedDonationRevenueNonCc;
	}

	public void setConfirmedDonationRevenueNonCc(BigDecimal confirmedDonationRevenueNonCc) {
		this.confirmedDonationRevenueNonCc = confirmedDonationRevenueNonCc;
	}

	public BigDecimal getConfirmedDonations() {
		return this.confirmedDonations;
	}

	public void setConfirmedDonations(BigDecimal confirmedDonations) {
		this.confirmedDonations = confirmedDonations;
	}

	public BigDecimal getConfirmedQuickSales() {
		return this.confirmedQuickSales;
	}

	public void setConfirmedQuickSales(BigDecimal confirmedQuickSales) {
		this.confirmedQuickSales = confirmedQuickSales;
	}

	public BigDecimal getConfirmedQuickSalesRevenueCc() {
		return this.confirmedQuickSalesRevenueCc;
	}

	public void setConfirmedQuickSalesRevenueCc(BigDecimal confirmedQuickSalesRevenueCc) {
		this.confirmedQuickSalesRevenueCc = confirmedQuickSalesRevenueCc;
	}

	public BigDecimal getConfirmedQuickSalesRevenueNonCc() {
		return this.confirmedQuickSalesRevenueNonCc;
	}

	public void setConfirmedQuickSalesRevenueNonCc(BigDecimal confirmedQuickSalesRevenueNonCc) {
		this.confirmedQuickSalesRevenueNonCc = confirmedQuickSalesRevenueNonCc;
	}

	public BigDecimal getConfirmedTicketOrders() {
		return this.confirmedTicketOrders;
	}

	public void setConfirmedTicketOrders(BigDecimal confirmedTicketOrders) {
		this.confirmedTicketOrders = confirmedTicketOrders;
	}

	public BigDecimal getConfirmedTicketOrdersRevenueCc() {
		return this.confirmedTicketOrdersRevenueCc;
	}

	public void setConfirmedTicketOrdersRevenueCc(BigDecimal confirmedTicketOrdersRevenueCc) {
		this.confirmedTicketOrdersRevenueCc = confirmedTicketOrdersRevenueCc;
	}

	public BigDecimal getConfirmedTicketOrdersRevenueNonCc() {
		return this.confirmedTicketOrdersRevenueNonCc;
	}

	public void setConfirmedTicketOrdersRevenueNonCc(BigDecimal confirmedTicketOrdersRevenueNonCc) {
		this.confirmedTicketOrdersRevenueNonCc = confirmedTicketOrdersRevenueNonCc;
	}
	...
	public double getNonBillableGms() {
		return this.nonBillableGms;
	}

	public void setNonBillableGms(double nonBillableGms) {
		this.nonBillableGms = nonBillableGms;
	}
	...
	public BigDecimal getUnconfirmedDonationRevenue() {
		return this.unconfirmedDonationRevenue;
	}

	public void setUnconfirmedDonationRevenue(BigDecimal unconfirmedDonationRevenue) {
		this.unconfirmedDonationRevenue = unconfirmedDonationRevenue;
	}

	public BigDecimal getUnconfirmedDonations() {
		return this.unconfirmedDonations;
	}

	public void setUnconfirmedDonations(BigDecimal unconfirmedDonations) {
		this.unconfirmedDonations = unconfirmedDonations;
	}

	public BigDecimal getUnconfirmedQuickSales() {
		return this.unconfirmedQuickSales;
	}

	public void setUnconfirmedQuickSales(BigDecimal unconfirmedQuickSales) {
		this.unconfirmedQuickSales = unconfirmedQuickSales;
	}

	public BigDecimal getUnconfirmedQuickSalesRevenue() {
		return this.unconfirmedQuickSalesRevenue;
	}

	public void setUnconfirmedQuickSalesRevenue(BigDecimal unconfirmedQuickSalesRevenue) {
		this.unconfirmedQuickSalesRevenue = unconfirmedQuickSalesRevenue;
	}

	public BigDecimal getUnconfirmedTicketOrders() {
		return this.unconfirmedTicketOrders;
	}

	public void setUnconfirmedTicketOrders(BigDecimal unconfirmedTicketOrders) {
		this.unconfirmedTicketOrders = unconfirmedTicketOrders;
	}

	public BigDecimal getUnconfirmedTicketOrdersRevenue() {
		return this.unconfirmedTicketOrdersRevenue;
	}

	public void setUnconfirmedTicketOrdersRevenue(BigDecimal unconfirmedTicketOrdersRevenue) {
		this.unconfirmedTicketOrdersRevenue = unconfirmedTicketOrdersRevenue;
	}
