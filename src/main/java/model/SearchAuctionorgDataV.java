...
/**
 * The persistent class for the search_auctionorg_data_v database table.
 * 
 */
@Entity
@Table(name="search_auctionorg_data_v")
@NamedQuery(name="SearchAuctionorgDataV.findAll", query="SELECT s FROM SearchAuctionorgDataV s")
public class SearchAuctionorgDataV implements Serializable {
