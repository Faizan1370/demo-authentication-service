...
/**
 * The persistent class for the billing_data_v database table.
 * 
 */
@Entity
@Table(name="billing_data_v")
@NamedQuery(name="BillingDataV.findAll", query="SELECT b FROM BillingDataV b")
public class BillingDataV implements Serializable {
