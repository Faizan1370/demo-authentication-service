...
/**
 * The persistent class for the item_bid_data_v database table.
 * 
 */
@Entity
@Table(name="item_bid_data_v")
@NamedQuery(name="ItemBidDataV.findAll", query="SELECT i FROM ItemBidDataV i")
public class ItemBidDataV implements Serializable {
