...
/**
 * The persistent class for the bidder_data_v database table.
 * 
 */
@Entity
@Table(name="bidder_data_v")
@NamedQuery(name="BidderDataV.findAll", query="SELECT b FROM BidderDataV b")
public class BidderDataV implements Serializable {
