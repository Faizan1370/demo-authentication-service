...
/**
 * The persistent class for the mv_item_bid_data database table.
 * 
 */
@Entity
@Table(name="mv_item_bid_data")
@NamedQuery(name="MvItemBidData.findAll", query="SELECT m FROM MvItemBidData m")
public class MvItemBidData implements Serializable {
