...
/**
 * The persistent class for the mv_auction_configs database table.
 * 
 */
@Entity
@Table(name="mv_auction_configs")
@NamedQuery(name="MvAuctionConfig.findAll", query="SELECT m FROM MvAuctionConfig m")
public class MvAuctionConfig implements Serializable {
