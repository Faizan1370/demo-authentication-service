...
/**
 * The persistent class for the bid_data_v database table.
 * 
 */
@Entity
@Table(name="bid_data_v")
@NamedQuery(name="BidDataV.findAll", query="SELECT b FROM BidDataV b")
public class BidDataV implements Serializable {
