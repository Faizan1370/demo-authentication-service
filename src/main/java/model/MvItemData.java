...
/**
 * The persistent class for the mv_item_data database table.
 * 
 */
@Entity
@Table(name="mv_item_data")
@NamedQuery(name="MvItemData.findAll", query="SELECT m FROM MvItemData m")
public class MvItemData implements Serializable {
