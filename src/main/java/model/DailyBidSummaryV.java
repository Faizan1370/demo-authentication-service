...
/**
 * The persistent class for the daily_bid_summary_v database table.
 * 
 */
@Entity
@Table(name="daily_bid_summary_v")
@NamedQuery(name="DailyBidSummaryV.findAll", query="SELECT d FROM DailyBidSummaryV d")
public class DailyBidSummaryV implements Serializable {
