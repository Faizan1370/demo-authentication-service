...
/**
 * The persistent class for the closed_and_single_item_data_v database table.
 * 
 */
@Entity
@Table(name="closed_and_single_item_data_v")
@NamedQuery(name="ClosedAndSingleItemDataV.findAll", query="SELECT c FROM ClosedAndSingleItemDataV c")
public class ClosedAndSingleItemDataV implements Serializable {
	...
	public ClosedAndSingleItemDataV() {
	}
