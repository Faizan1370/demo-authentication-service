...
/**
 * The persistent class for the internal_billing_data_v database table.
 * 
 */
@Entity
@Table(name="internal_billing_data_v")
@NamedQuery(name="InternalBillingDataV.findAll", query="SELECT i FROM InternalBillingDataV i")
public class InternalBillingDataV implements Serializable {
	...
	private double billingGmsCc;

	@Column(name="billing_gms_non_cc")
	private double billingGmsNonCc;
	...
	private Long confirmedQuickSales;
	...
	private Long confirmedTicketOrders;
	...
	private Long unconfirmedQuickSales;
	...
	public double getBillingGmsCc() {
		return this.billingGmsCc;
	}

	public void setBillingGmsCc(double billingGmsCc) {
		this.billingGmsCc = billingGmsCc;
	}

	public double getBillingGmsNonCc() {
		return this.billingGmsNonCc;
	}

	public void setBillingGmsNonCc(double billingGmsNonCc) {
	...
	public Long getConfirmedDonations() {
		return this.confirmedDonations;
	}

	public void setConfirmedDonations(Long confirmedDonations) {
		this.confirmedDonations = confirmedDonations;
	}

	public Long getConfirmedQuickSales() {
		return this.confirmedQuickSales;
	}

	public void setConfirmedQuickSales(Long confirmedQuickSales) {
	...
	public Long getConfirmedTicketOrders() {
		return this.confirmedTicketOrders;
	}

	public void setConfirmedTicketOrders(Long confirmedTicketOrders) {
	...
	public Long getUnconfirmedDonations() {
		return this.unconfirmedDonations;
	}

	public void setUnconfirmedDonations(Long unconfirmedDonations) {
		this.unconfirmedDonations = unconfirmedDonations;
	}

	public Long getUnconfirmedQuickSales() {
		return this.unconfirmedQuickSales;
	}

	public void setUnconfirmedQuickSales(Long unconfirmedQuickSales) {
	...
	public Long getUnconfirmedTicketOrders() {
		return this.unconfirmedTicketOrders;
	}

	public void setUnconfirmedTicketOrders(Long unconfirmedTicketOrders) {
