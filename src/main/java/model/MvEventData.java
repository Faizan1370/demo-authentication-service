...
/**
 * The persistent class for the mv_event_data database table.
 * 
 */
@Entity
@Table(name="mv_event_data")
@NamedQuery(name="MvEventData.findAll", query="SELECT m FROM MvEventData m")
public class MvEventData implements Serializable {
