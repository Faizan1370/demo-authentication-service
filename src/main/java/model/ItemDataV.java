...
/**
 * The persistent class for the item_data_v database table.
 * 
 */
@Entity
@Table(name="item_data_v")
@NamedQuery(name="ItemDataV.findAll", query="SELECT i FROM ItemDataV i")
public class ItemDataV implements Serializable {
